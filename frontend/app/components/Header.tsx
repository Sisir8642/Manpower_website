    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="hidden lg:flex items-center justify-between text-xs">
        ...
        <div className="flex items-center gap-5">
          <a href="https://www.facebook.com/share/1AEniKV8x2/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-600 transition-colors">
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
            </svg>
          </a>
          <a href="https://www.linkedin.com/company/118384280/admin/dashboard/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-700 transition-colors">
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
