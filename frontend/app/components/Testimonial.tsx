...
export default function TestimonialSection() {
  ...
  return (
    <>
    <h1 className="text-4xl flex items-center justify-center text-black-300 shadow-olive-400 bg-gray-50 mb-2"> Testimonials</h1>
      <style>{`
...
className="absolute top-0 right-0 md:right-0 w-full md:w-1/2 h-full bg-cover bg-center opacity-30 z-0"
  ...
  />
        ...
        {/* Vignette overlay */}
        <div className="absolute inset-0 z-[1] bg-[radial-gradient(ellipse_55%_80%_at_10%_50%,rgba(20,15,10,0.7),transparent_50%),radial-gradient(ellipse_55%_80%_at_90%_50%,rgba(10,15,20,0.7),transparent_50%),radial-gradient(ellipse_40%_60%_at_50%_50%,rgba(5,5,5,0.9),transparent_100%)]" />
